...
func Usage() {
	...
	u_general := UsageSection{
		...
		Flags:         make([]UsageFlag, 0),
		Hidden:        false,
		ExpectedFlags: []string{"ac", "acc", "c", "config", "maxtime", "maxtime-job", "p", "rate", "s", "sa", "se", "sf", "st", "t", "v", "V"},
	}
	...
	fmt.Printf("  More information and examples: https://github.com/Damian89/ffuf\n\n")
}
