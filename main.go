...
func ParseFlags(opts *ffuf.ConfigOptions) *ffuf.ConfigOptions {
	...
	flag.BoolVar(&opts.HTTP.CTJSON, "ct-json", opts.HTTP.CTJSON, "Set Content-Type to application/json")
	flag.BoolVar(&opts.HTTP.CTXML, "ct-xml", opts.HTTP.CTXML, "Set Content-Type to application/xml")
	flag.BoolVar(&opts.HTTP.CTForm, "ct-form", opts.HTTP.CTForm, "Set Content-Type to application/x-www-form-urlencoded")
	flag.BoolVar(&opts.HTTP.CTFormData, "ct-formdata", opts.HTTP.CTFormData, "Set Content-Type to multipart/form-data")
	flag.BoolVar(&opts.HTTP.CTText, "ct-text", opts.HTTP.CTText, "Set Content-Type to text/plain")
	flag.BoolVar(&opts.HTTP.CTHTML, "ct-html", opts.HTTP.CTHTML, "Set Content-Type to text/html")
	flag.BoolVar(&opts.HTTP.CTCSV, "ct-csv", opts.HTTP.CTCSV, "Set Content-Type to text/csv")
	flag.BoolVar(&opts.HTTP.CTPDF, "ct-pdf", opts.HTTP.CTPDF, "Set Content-Type to application/pdf")
	flag.BoolVar(&opts.HTTP.CTJPEG, "ct-jpeg", opts.HTTP.CTJPEG, "Set Content-Type to image/jpeg")
	flag.BoolVar(&opts.HTTP.CTPNG, "ct-png", opts.HTTP.CTPNG, "Set Content-Type to image/png")
	// Accept shortcuts
	flag.BoolVar(&opts.HTTP.ACJSON, "ac-json", opts.HTTP.ACJSON, "Set Accept to application/json")
	flag.BoolVar(&opts.HTTP.ACXML, "ac-xml", opts.HTTP.ACXML, "Set Accept to application/xml")
	flag.BoolVar(&opts.HTTP.ACHTML, "ac-html", opts.HTTP.ACHTML, "Set Accept to text/html")
	flag.BoolVar(&opts.HTTP.ACText, "ac-text", opts.HTTP.ACText, "Set Accept to text/plain")
	flag.BoolVar(&opts.HTTP.ACAny, "ac-any", opts.HTTP.ACAny, "Set Accept to */*")
	flag.BoolVar(&opts.HTTP.ACImage, "ac-image", opts.HTTP.ACImage, "Set Accept to image/*")
	// Language shortcuts
	flag.BoolVar(&opts.HTTP.LgES, "lg-es", opts.HTTP.LgES, "Set Accept-Language to es-ES")
	flag.BoolVar(&opts.HTTP.LgEN, "lg-en", opts.HTTP.LgEN, "Set Accept-Language to en-US")
	flag.BoolVar(&opts.HTTP.LgFR, "lg-fr", opts.HTTP.LgFR, "Set Accept-Language to fr-FR")
	flag.BoolVar(&opts.HTTP.LgDE, "lg-de", opts.HTTP.LgDE, "Set Accept-Language to de-DE")
	flag.BoolVar(&opts.HTTP.LgZH, "lg-zh", opts.HTTP.LgZH, "Set Accept-Language to zh-CN")
	flag.BoolVar(&opts.HTTP.LgJA, "lg-ja", opts.HTTP.LgJA, "Set Accept-Language to ja-JP")
	// Encoding shortcuts
	flag.BoolVar(&opts.HTTP.EncGzip, "enc-gzip", opts.HTTP.EncGzip, "Set Accept-Encoding to gzip")
	flag.BoolVar(&opts.HTTP.EncDeflate, "enc-deflate", opts.HTTP.EncDeflate, "Set Accept-Encoding to deflate")
	flag.BoolVar(&opts.HTTP.EncBr, "enc-br", opts.HTTP.EncBr, "Set Accept-Encoding to br")
	flag.BoolVar(&opts.HTTP.EncIdentity, "enc-identity", opts.HTTP.EncIdentity, "Set Accept-Encoding to identity")
	// Authorization shortcuts
	flag.StringVar(&opts.HTTP.AuthBearer, "ath-bearer", opts.HTTP.AuthBearer, "Authorization: Bearer token")
	flag.StringVar(&opts.HTTP.AuthBasic, "ath-basic", opts.HTTP.AuthBasic, "Authorization: Basic credentials")
	flag.StringVar(&opts.HTTP.AuthToken, "ath-token", opts.HTTP.AuthToken, "Authorization: Token token")
	...
	flag.BoolVar(&opts.Input.ExcludeCommentLines, "xc-c", opts.Input.ExcludeCommentLines, "Exclude lines starting with #, ~, or / from wordlist")
	flag.BoolVar(&opts.Input.ExcludeDotLines, "xc-d", opts.Input.ExcludeDotLines, "Exclude lines starting with . from wordlist")
	flag.BoolVar(&opts.Input.ExcludeNumberLines, "xc-n", opts.Input.ExcludeNumberLines, "Exclude lines starting with numbers from wordlist")
	flag.BoolVar(&opts.Input.ExcludeUppercase, "xc-upper", opts.Input.ExcludeUppercase, "Exclude lines that are entirely uppercase from wordlist")
	flag.BoolVar(&opts.Input.ExcludeLowercase, "xc-lower", opts.Input.ExcludeLowercase, "Exclude lines that are entirely lowercase from wordlist")
	flag.BoolVar(&opts.Input.ExcludeStartUpper, "xc-s-upper", opts.Input.ExcludeStartUpper, "Exclude lines starting with uppercase letter from wordlist")
	flag.BoolVar(&opts.Input.ExcludeStartLower, "xc-s-lower", opts.Input.ExcludeStartLower, "Exclude lines starting with lowercase letter from wordlist")
